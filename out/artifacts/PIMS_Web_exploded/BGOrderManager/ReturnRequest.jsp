        ...
        <div >
            <el-form :model="Returnvalue" label-width="120px" style="height:auto" size="small">
                ...
                <el-form-item label="退货原因描述：" prop="ReturnDescribe">
                    <el-input v-model="Returnvalue.ReturnDescribe" ></el-input>
                </el-form-item>
                <el-form-item label="处理备注：" prop="ServiceRemark" readonly>
                    <el-input v-model="Returnvalue.ServiceRemark" readonly></el-input>
                </el-form-item>
                </el-form-item>
                <el-button type="primary" size="medium" @click="pass" style="position: relative;left:44%;">发起退货申请</el-button>
                </el-form-item>
            </el-form>
        </div>
    </el-card>
...
<script>
    var app=new Vue({
            ...
            return {
                Returnvalue:{
                    <%
                        ...
                        if(checkreturn!=null||checkreturn.size()!=0){
                    %>
                    <%
        ...
        methods: {
            pass(){
                window.location.href="http://localhost:8080/ReturnRequestServlet?OrderId="+this.Returnvalue.OrderId
                    +"&ReturnDescribe="+this.Returnvalue.ReturnDescribe
                    +"&ServiceRemark="+this.Returnvalue.ServiceRemark;
            },
        }
    })
</script>
